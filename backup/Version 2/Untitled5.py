...
def calculate_threshold(boxes):
    ...
    vertical_gaps = [boxes[i][1] - boxes[i-1][3] for i in range(1, len(boxes))]

    # Calculate the threshold as a percentile of the vertical gaps
    threshold_percentile = 75  # Adjust percentile as needed
    threshold = np.percentile(vertical_gaps, threshold_percentile)
